...
ps ← {
    ...
    (a=2) ∧ (0=c d b) ∧ (mk[4] ≠ 0) ∧ (3 ≥ c d mk[4] ):  4 fm 2
    (a=2) ∧ (0=c d b) ∧ (mk[4] ≠ 0) ∧ (3 < c d mk[4]):  5 fm 2
    (a=2): 2

    (a=1) ∧ (mk[1]≠0) ∧ (4 ≤ c d mk[1]): 2 fm 1 
    (a=1) ∧ (5 =c d b) ∧ (mk[2]=0): 2 fm 1
    (a=1) ∧ (0=c d b) ∧ (mk[4] = 0) :  4 fm 1
    (a=1) ∧ (0=c d b) ∧ (mk[3] ≠ 0) ∧ (3 ≥ c d mk[3]) :  3 fm 1
    ...
    (a=0) ∧ (0=c d b) ∧ (mk[3] ≠ 0) ∧ (3 ≥ c d mk[3]) :  3 fm 0
    (a=0) ∧ (0=c d b) ∧ (mk[4] ≠ 0) ∧ (3 ≥ c d mk[4]) :  4 fm 0
    (a=0) ∧ (0=c d b) ∧ (mk[4] ≠ 0) ∧ (3 < c d mk[4]) :  5 fm 0
    (a=0): 0

    (a=3) ∧ (5 =c d b) ∧ (mk[1] = 0): 1 fm 3
    (a=3) ∧ (5=c d b) ∧ (mk[1] ≠ 0) ∧ (3 < c d mk[1]) :  1 fm 3
    (a=3) ∧ (5=c d b) ∧ (mk[1] ≠ 0) ∧ (3 ≥ c d mk[1]) :  0 fm 3
    (a=3):3 

    
    (a=4) ∧ (mk[4]≠0) ∧ (1 ≥ c d mk[4]): 3 fm 4
    (a=4) ∧ (0=c d b) ∧ (mk[2]=0): 3 fm 4
    (a=4) ∧ (5=c d b) ∧ (mk[1] = 0) :  1 fm 4
    (a=4) ∧ (5=c d b) ∧ (mk[2] ≠ 0) ∧ (3 ≥ c d mk[2]) :  2 fm 4
    (a=4) ∧ (5=c d b) ∧ (mk[1] ≠ 0) ∧ (3 < c d mk[1]) :  1 fm 4
    (a=4) ∧ (5=c d b) ∧ (mk[1] ≠ 0) ∧ (3 ≥ c d mk[1]) :  0 fm 4
    (a=4): 4



    (a=5) ∧ (mk[4]≠0) ∧ (2 ≥ c d mk[4]) : 4 fm 5
    (a=5) ∧ (5=c d b) ∧ (mk[1] = 0) :  1 fm 5 
    (a=5) ∧ (5=c d b) ∧ (mk[3] ≠ 0) ∧ (3 ≥ c d mk[2]) :  2 fm 5
...
2 s 63.25 56.625 56.5 61.625 61.875 56.125 54.25 52 57.625 58 51.875 51.125 50.875 57.125 59.125 60.125 60.375 62 63 64.25
